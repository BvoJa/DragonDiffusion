...
def create_demo_paste(runner):
    ...
    with gr.Blocks() as demo:
        ...
        run_button.click(fn=runner, inputs=[img_base, mask_base, original_image, prompt, prompt_replace, w_edit, w_content, w_grad, w_style, seed, guidance_scale, energy_scale, dx, dy, resize_scale, max_resolution, SDE_strength, ip_scale], outputs=[output])
    return demo